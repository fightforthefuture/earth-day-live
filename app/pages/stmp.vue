<template>
  <div class="container-fluid petition-signup-form-container">
    <div class="petition-signup-form-wrapper">
      <div id="can-form-area-tell-wall-street-and-congress-stop-the-money-pipeline-to-the-fossil-fuel-industry"></div>
      <p class="splash-page-disclaimer">
        You may receive updates from<i>Stop the Money Pipeline</i>, the sponsor of this form
      </p>
    </div>
  </div>
</template>
...
<script>
    export default {
      head () {
        ...
        return {
          script: [
            { src: `https://actionnetwork.org/widgets/v3/form/tell-wall-street-and-congress-stop-the-money-pipeline-to-the-fossil-fuel-industry?format=js&source=widget` }
          ],
          link: [
...
<style>
  .petition-signup-form-container {
  ...
  #can-form-area-tell-wall-street-and-congress-stop-the-money-pipeline-to-the-fossil-fuel-industry {
    border: none !important;
    background-color: #190825;
  }

  #can-form-area-tell-wall-street-and-congress-stop-the-money-pipeline-to-the-fossil-fuel-industry #can_embed_form {
    border: none !important;
  ...
  #can-form-area-tell-wall-street-and-congress-stop-the-money-pipeline-to-the-fossil-fuel-industry #can_embed_form #can_thank_you {
    background-color: #190825 !important;
  }

  #can-form-area-tell-wall-street-and-congress-stop-the-money-pipeline-to-the-fossil-fuel-industry #can_embed_form #can_thank_you h1 {
    font-family: titling-gothic-fb, sans-serif !important;
  }

  #can-form-area-tell-wall-street-and-congress-stop-the-money-pipeline-to-the-fossil-fuel-industry #can_embed_form .can_thank_you-block h4 {
    color: #fff !important;
    font-family: neue-haas-grotesk-display, sans-serif !important;
  }
